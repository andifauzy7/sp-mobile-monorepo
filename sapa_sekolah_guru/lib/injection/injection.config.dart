...
import 'package:sapa_sekolah_guru/bloc/add_activity/add_activity_bloc.dart'
    as _i21;
import 'package:sapa_sekolah_guru/bloc/add_lesson/add_lesson_bloc.dart' as _i22;
import 'package:sapa_sekolah_guru/bloc/add_lesson_plan/add_lesson_plan_bloc.dart'
    as _i23;
import 'package:sapa_sekolah_guru/bloc/add_permit/add_permit_bloc.dart' as _i24;
...
import 'package:sapa_sekolah_guru/shared/core/core_module.dart' as _i34;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i19.SplashCubit>(
        () => _i19.SplashCubit(authRepository: gh<_i9.AuthRepository>()));
    gh.factory<_i20.SubmitStudentAttendanceBloc>(() =>
        _i20.SubmitStudentAttendanceBloc(
            attendanceRepository: gh<_i8.AttendanceRepository>()));
    gh.factory<_i21.AddActivityBloc>(() =>
        _i21.AddActivityBloc(lessonRepository: gh<_i14.LessonRepository>()));
    gh.factory<_i22.AddLessonBloc>(() =>
        _i22.AddLessonBloc(lessonRepository: gh<_i14.LessonRepository>()));
    gh.factory<_i23.AddLessonPlanBloc>(() =>
        _i23.AddLessonPlanBloc(lessonRepository: gh<_i14.LessonRepository>()));
    gh.factory<_i24.AddPermitBloc>(() =>
        _i24.AddPermitBloc(permitRepository: gh<_i17.PermitRepository>()));
    gh.factory<_i25.DeleteLessonPlanBloc>(() => _i25.DeleteLessonPlanBloc(
        lessonRepository: gh<_i14.LessonRepository>()));
    gh.factory<_i26.GetActivitiesBloc>(() =>
        _i26.GetActivitiesBloc(lessonRepository: gh<_i14.LessonRepository>()));
    gh.factory<_i27.GetDailyReportDetailBloc>(() =>
        _i27.GetDailyReportDetailBloc(
            reportRepository: gh<_i18.ReportRepository>()));
    gh.factory<_i28.GetDailyReportsBloc>(() => _i28.GetDailyReportsBloc(
        reportRepository: gh<_i18.ReportRepository>()));
    gh.factory<_i29.GetLessonPlanDetailBloc>(() => _i29.GetLessonPlanDetailBloc(
        lessonRepository: gh<_i14.LessonRepository>()));
    gh.factory<_i30.GetLessonPlansBloc>(() =>
        _i30.GetLessonPlansBloc(lessonRepository: gh<_i14.LessonRepository>()));
    gh.factory<_i31.GetLessonsBloc>(() =>
        _i31.GetLessonsBloc(lessonRepository: gh<_i14.LessonRepository>()));
    gh.factory<_i32.GetPermitTypeBloc>(() =>
        _i32.GetPermitTypeBloc(permitRepository: gh<_i17.PermitRepository>()));
    gh.factory<_i33.GetStudentPermitsBloc>(() => _i33.GetStudentPermitsBloc(
