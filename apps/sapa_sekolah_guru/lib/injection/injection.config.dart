...
import 'package:sapa_sekolah_guru/bloc/add_consultation_response/add_consultation_response_bloc.dart'
    as _i25;
import 'package:sapa_sekolah_guru/bloc/add_lesson/add_lesson_bloc.dart' as _i26;
import 'package:sapa_sekolah_guru/bloc/add_lesson_plan/add_lesson_plan_bloc.dart'
    as _i27;
import 'package:sapa_sekolah_guru/bloc/add_permit/add_permit_bloc.dart' as _i28;
...
import 'package:sapa_sekolah_guru/shared/core/core_module.dart' as _i42;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i23.UpdateMonthlyReportBloc>(() => _i23.UpdateMonthlyReportBloc(
        reportRepository: gh<_i19.ReportRepository>()));
    gh.factory<_i24.AddActivityBloc>(() =>
        _i24.AddActivityBloc(lessonRepository: gh<_i15.LessonRepository>()));
    gh.factory<_i25.AddConsultationResponseBloc>(() =>
        _i25.AddConsultationResponseBloc(
            consultationRepository: gh<_i9.ConsultationRepository>()));
    gh.factory<_i26.AddLessonBloc>(() =>
        _i26.AddLessonBloc(lessonRepository: gh<_i15.LessonRepository>()));
    gh.factory<_i27.AddLessonPlanBloc>(() =>
        _i27.AddLessonPlanBloc(lessonRepository: gh<_i15.LessonRepository>()));
    gh.factory<_i28.AddPermitBloc>(() =>
        _i28.AddPermitBloc(permitRepository: gh<_i18.PermitRepository>()));
    gh.factory<_i29.DeleteLessonPlanBloc>(() => _i29.DeleteLessonPlanBloc(
        lessonRepository: gh<_i15.LessonRepository>()));
    gh.factory<_i30.DeleteMonthlyReportBloc>(() => _i30.DeleteMonthlyReportBloc(
        reportRepository: gh<_i19.ReportRepository>()));
    gh.factory<_i31.GetActivitiesBloc>(() =>
        _i31.GetActivitiesBloc(lessonRepository: gh<_i15.LessonRepository>()));
    gh.factory<_i32.GetDailyReportDetailBloc>(() =>
        _i32.GetDailyReportDetailBloc(
            reportRepository: gh<_i19.ReportRepository>()));
    gh.factory<_i33.GetDailyReportsBloc>(() => _i33.GetDailyReportsBloc(
        reportRepository: gh<_i19.ReportRepository>()));
    gh.factory<_i34.GetLessonPlanDetailBloc>(() => _i34.GetLessonPlanDetailBloc(
        lessonRepository: gh<_i15.LessonRepository>()));
    gh.factory<_i35.GetLessonPlansBloc>(() =>
        _i35.GetLessonPlansBloc(lessonRepository: gh<_i15.LessonRepository>()));
    gh.factory<_i36.GetLessonsBloc>(() =>
        _i36.GetLessonsBloc(lessonRepository: gh<_i15.LessonRepository>()));
    gh.factory<_i37.GetMonthlyReportComponentBloc>(() =>
        _i37.GetMonthlyReportComponentBloc(
            reportRepository: gh<_i19.ReportRepository>()));
    gh.factory<_i38.GetMonthlyReportDetailBloc>(() =>
        _i38.GetMonthlyReportDetailBloc(
            reportRepository: gh<_i19.ReportRepository>()));
    gh.factory<_i39.GetMonthlyReportsBloc>(() => _i39.GetMonthlyReportsBloc(
        reportRepository: gh<_i19.ReportRepository>()));
    gh.factory<_i40.GetPermitTypeBloc>(() =>
        _i40.GetPermitTypeBloc(permitRepository: gh<_i18.PermitRepository>()));
    gh.factory<_i41.GetStudentPermitsBloc>(() => _i41.GetStudentPermitsBloc(
        permitRepository: gh<_i18.PermitRepository>()));
    return this;
  }
}

class _$CoreModule extends _i42.CoreModule {}
